...
using WithEmbeddedIdentityServer.Data;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using WithEmbeddedIdentityServer.Common.Middleware;

namespace WithEmbeddedIdentityServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Adds the default In-Memory authorization server. Data is read from appsettings.
